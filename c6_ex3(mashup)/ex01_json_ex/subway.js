...
function handleRefresh() {
  console.log("here");
  var url =
    "http://openapi.seoul.go.kr:8088/486e485945646179313036596c477073/json/CardSubwayStatsNew/1/100/20200101/";
...
function updateTraffic(subwaypeople) {
  ...
  for (var i = 0; i < traffic.length; i++) {
    ...
    div.innerHTML =
      ...
      traffic[i].LINE_NUM +
      "에 " +
      traffic[i].SUB_STA_NM +
      "역에서 " +
      traffic[i].RIDE_PASGR_NUM +
      "명이 승차하고 " +
      traffic[i].ALIGHT_PASGR_NUM +
      "명이 내렸습니다. ";
    subwayDiv.appendChild(div);
  }
}
